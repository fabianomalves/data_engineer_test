...
- <a href="https://ua8vha.deta.dev/docs" target="_blank">Swagger UI</a>
- <a href="https://ua8vha.deta.dev/redoc" target="_blank">ReDoc UI</a>
...
**Regras de negócio**
* Precisamos saber o estado que a pessoa acessou nossos serviços, com as coordenadas `address.geo_latitude` e `address.geo_longitude` dos usuários devemos criar uma coluna de estado chamada `address_state`, processo denominado <a href="https://en.wikipedia.org/wiki/Reverse_geocoding" target="_blank">reverse geocode</a>
...
* :mag_right: Você sabia que o <a href="http://clubes.obmep.org.br/blog/a-matematica-nos-documentos-cpf/" target="_blank">nono dígito do CPF corresponde a Região Fiscal emissora do CPF</a>? Sabendo disso, nosso time precisa saber qual a Região Fiscal que esse CPF foi registrado:
...
Leia sobre <a href="https://cloud.google.com/bigquery/docs/schemas#column_names" target="_blank">Nomes de coluna BigQuery</a>
